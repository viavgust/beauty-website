...
export const testimonials = [
  ...
  {
    id: 2,
    text: 'Прошла базовый курс у Анны. Теперь умею краситься сама и понимаю, какая косметика мне подходит. Очень рекомендую!',
    name: 'Елена С.',
    role: 'Ученица',
  ...
  {
    id: 3,
    text: 'Работаем с Анной на всех наших съёмках. Всегда попадает в настроение проекта и находит общий язык с моделями.',
    name: 'Дмитрий В.',
    role: 'Фотограф',
